...
?>
    <div id="main_viewDetails">
        ...
        <div id="right_viewDetails">
            ...
            <div id="bottom">
                <h1 style="border-color:black"> Welcome to the Fees Section</h1>
                    ...
                    <table>
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                echo "
                                <tr>
                                <form action='./student_fees_record.php' method='post'>
                                ...
                                <td><button type='submit' class='btn' >Fees Details</button></td> 
